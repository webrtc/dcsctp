...
mod tests {
    ...
    fn from_capture() {
        ...
        let chunk =
            HeartbeatRequestChunk::try_from(RawChunk::try_from_bytes(BYTES).unwrap().0).unwrap();
    ...
    fn serialize_and_deserialize() {
        ...
        let deserialized =
            HeartbeatRequestChunk::try_from(RawChunk::try_from_bytes(&serialized).unwrap().0)
                .unwrap();
